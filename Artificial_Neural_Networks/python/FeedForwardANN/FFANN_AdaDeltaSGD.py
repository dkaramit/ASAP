...
class AdaDeltaSGD:
    ...
    '''
    def __init__(self,model,loss,gamma=0.995,epsilon=1e-4,alpha=1):
        '''
        ...
        self.mean_dw=[ [[0 for i in range(self.model.nodes[l])] for j in range(self.model.nodes[l+1])]  for l in range(self.model.total_layers-1)]
        self.mean_db=[ [0 for j in range(self.model.nodes[l+1])]  for l in range(self.model.total_layers-1)]      

        self.mean_dQdw=[ [[0 for i in range(self.model.nodes[l])] for j in range(self.model.nodes[l+1])]  for l in range(self.model.total_layers-1)]
        self.mean_dQdb=[ [0 for j in range(self.model.nodes[l+1])]  for l in range(self.model.total_layers-1)]      
